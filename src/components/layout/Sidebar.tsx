...
import { LayoutDashboard, TrendingUp, ArrowUpDown, Users, PlusCircle, LogOut, DollarSign } from "lucide-react";
  ...
  return (
    <div className="flex h-full w-full flex-col bg-card border-r border-border">
      <div className="p-6">
        ...
        {user && (
          <p className="text-sm text-muted-foreground truncate">Olá, {user.email}</p>
        )}
      </div>
